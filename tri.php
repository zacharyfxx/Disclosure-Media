...
//4552000
$url = "https://cdec.water.ca.gov/cgi-progs/queryF?CLE";
...
//echo $arr[1];
$output = "[".substr($date[$h],11,5)."] Trinity ".$cap." Storage: ".number_format($storage[$h],0,'.',',')." AF (".$storage_rise1."AF, 24h".$storage_rise24."AF) Elevation: ".number_format($res_ele[$h],0,'.',',')."'(".$ele_rise1."', 24h:".$ele_rise24."') Outflow: ".number_format($outflow[$h],0,'.',',')."CFS Inflow: ".number_format($inflow[$h],0,'.',',')."CFS ".$net1;
